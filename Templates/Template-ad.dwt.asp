...
<!-- TemplateEndEditable -->
<link rel="shortcut icon" href="../Webselllap/images/icon.png">
    ...
    <div class="cntr">
        <div class="cntr-innr">
          <form action="search.asp" method="get" class="search">
              <%
                   %>
                <input id="inpt_search" type="search" placeholder="Nhập vào tên cần tìm"/>
          </form>
...
<div class="pages-top">
    <div class="logo">
        <a href="index.asp"><img src="../Webselllap/images/logo.png" alt=""/></a>
    </div>
	 	...
	 	<div class="wrap">
	 		<div class="pages">
				<div class="cont1 span_2_of_g1">
                    ...
                    <% 'Hiển thị nút "Trước"     
                        if x>1 then %>     
                    <a href="timkiem.asp?pageNumber=<%=x-1%>">Trước</a>     
                    <%end if%> 
                    <% 'Hiển thị nút "Tiếp"     
                        if not RS.EOF then %>        
                    <a style="padding-left: 800px;" href="timkiem.asp?pageNumber=<%=x+1%>">Tiếp</a>     
                    <%end if     
