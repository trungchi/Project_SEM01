...
<%
Dim DESKTOP_LENOVO
Dim DESKTOP_LENOVO_cmd
Dim DESKTOP_LENOVO_numRows

Set DESKTOP_LENOVO_cmd = Server.CreateObject ("ADODB.Command")
DESKTOP_LENOVO_cmd.ActiveConnection = MM_Connection_STRING
DESKTOP_LENOVO_cmd.CommandText = "SELECT * FROM dbo.SanPham WHERE Tinhtrang = 1 and MaLoai = 2   and MaNSX = 6" 
DESKTOP_LENOVO_cmd.Prepared = true

Set DESKTOP_LENOVO = DESKTOP_LENOVO_cmd.Execute
DESKTOP_LENOVO_numRows = 0
%>
<%
...
Repeat1__numRows = 9
Repeat1__index = 0
DESKTOP_LENOVO_numRows = DESKTOP_LENOVO_numRows + Repeat1__numRows
%>
<%
'  *** Recordset Stats, Move To Record, and Go To Record: declare stats variables

Dim DESKTOP_LENOVO_total
Dim DESKTOP_LENOVO_first
Dim DESKTOP_LENOVO_last

' set the record count
DESKTOP_LENOVO_total = DESKTOP_LENOVO.RecordCount

' set the number of rows displayed on this page
If (DESKTOP_LENOVO_numRows < 0) Then
  DESKTOP_LENOVO_numRows = DESKTOP_LENOVO_total
Elseif (DESKTOP_LENOVO_numRows = 0) Then
  DESKTOP_LENOVO_numRows = 1
End If

' set the first and last displayed record
DESKTOP_LENOVO_first = 1
DESKTOP_LENOVO_last  = DESKTOP_LENOVO_first + DESKTOP_LENOVO_numRows - 1

' if we have the correct record count, check the other stats
If (DESKTOP_LENOVO_total <> -1) Then
  If (DESKTOP_LENOVO_first > DESKTOP_LENOVO_total) Then
    DESKTOP_LENOVO_first = DESKTOP_LENOVO_total
  End If
  If (DESKTOP_LENOVO_last > DESKTOP_LENOVO_total) Then
    DESKTOP_LENOVO_last = DESKTOP_LENOVO_total
  End If
  If (DESKTOP_LENOVO_numRows > DESKTOP_LENOVO_total) Then
    DESKTOP_LENOVO_numRows = DESKTOP_LENOVO_total
  End If
End If
%>
...
Set MM_rs    = DESKTOP_LENOVO
MM_rsCount   = DESKTOP_LENOVO_total
MM_size      = DESKTOP_LENOVO_numRows
MM_uniqueCol = ""
MM_paramName = ""
MM_offset = 0
MM_atTotal = false
...
' set the first and last displayed record
DESKTOP_LENOVO_first = MM_offset + 1
DESKTOP_LENOVO_last  = MM_offset + MM_size

If (MM_rsCount <> -1) Then
  If (DESKTOP_LENOVO_first > MM_rsCount) Then
    DESKTOP_LENOVO_first = MM_rsCount
  End If
  If (DESKTOP_LENOVO_last > MM_rsCount) Then
    DESKTOP_LENOVO_last = MM_rsCount
  End If
End If
	 	...
	 	<div class="wrap">
	 		<div class="pages">
				<div class="cont1 span_2_of_g1">
				  <p>CÁC SẢN PHẨM MÁY DESKTOP LENOVO MỚI NHẤT</p>
				  <p>&nbsp;</p>
                  <% 
While ((Repeat1__numRows <> 0) AND (NOT DESKTOP_LENOVO.EOF)) 
%>
  <div class="oneItem">
    <p><img src="<%=(DESKTOP_LENOVO.Fields.Item("HinhAnh").Value)%>" alt="" width="225" height="150">Sản phẩm: <%=(DESKTOP_LENOVO.Fields.Item("TenSP").Value)%></p>
    <p>Giá: <%=(DESKTOP_LENOVO.Fields.Item("Gia").Value)%></p>
    <p>Hiện còn <%=(DESKTOP_LENOVO.Fields.Item("SoLuong").Value)%> sản phẩm</p>
    <p>&nbsp;</p>
    <form name="form1" method="post" action="ctspDesktop.asp">
      <input name="MaSP" type="hidden" id="MaSP" value="<%=(DESKTOP_LENOVO.Fields.Item("MaSP").Value)%>">
      <label>
...
<%
DESKTOP_LENOVO.Close()
Set DESKTOP_LENOVO = Nothing
%>
