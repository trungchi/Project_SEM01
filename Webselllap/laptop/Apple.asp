...
<%
Dim LAPTOP_APPLE
Dim LAPTOP_APPLE_cmd
Dim LAPTOP_APPLE_numRows

Set LAPTOP_APPLE_cmd = Server.CreateObject ("ADODB.Command")
LAPTOP_APPLE_cmd.ActiveConnection = MM_Connection_STRING
LAPTOP_APPLE_cmd.CommandText = "SELECT * FROM dbo.SanPham WHERE Tinhtrang = 1 and MaLoai = 1  and MaNSX = 5" 
LAPTOP_APPLE_cmd.Prepared = true

Set LAPTOP_APPLE = LAPTOP_APPLE_cmd.Execute
LAPTOP_APPLE_numRows = 0
%>
<%
...
Repeat1__numRows = 9
Repeat1__index = 0
LAPTOP_APPLE_numRows = LAPTOP_APPLE_numRows + Repeat1__numRows
%>
<%
'  *** Recordset Stats, Move To Record, and Go To Record: declare stats variables

Dim LAPTOP_APPLE_total
Dim LAPTOP_APPLE_first
Dim LAPTOP_APPLE_last

' set the record count
LAPTOP_APPLE_total = LAPTOP_APPLE.RecordCount

' set the number of rows displayed on this page
If (LAPTOP_APPLE_numRows < 0) Then
  LAPTOP_APPLE_numRows = LAPTOP_APPLE_total
Elseif (LAPTOP_APPLE_numRows = 0) Then
  LAPTOP_APPLE_numRows = 1
End If

' set the first and last displayed record
LAPTOP_APPLE_first = 1
LAPTOP_APPLE_last  = LAPTOP_APPLE_first + LAPTOP_APPLE_numRows - 1

' if we have the correct record count, check the other stats
If (LAPTOP_APPLE_total <> -1) Then
  If (LAPTOP_APPLE_first > LAPTOP_APPLE_total) Then
    LAPTOP_APPLE_first = LAPTOP_APPLE_total
  End If
  If (LAPTOP_APPLE_last > LAPTOP_APPLE_total) Then
    LAPTOP_APPLE_last = LAPTOP_APPLE_total
  End If
  If (LAPTOP_APPLE_numRows > LAPTOP_APPLE_total) Then
    LAPTOP_APPLE_numRows = LAPTOP_APPLE_total
  End If
End If
%>
...
Set MM_rs    = LAPTOP_APPLE
MM_rsCount   = LAPTOP_APPLE_total
MM_size      = LAPTOP_APPLE_numRows
MM_uniqueCol = ""
MM_paramName = ""
MM_offset = 0
MM_atTotal = false
...
' set the first and last displayed record
LAPTOP_APPLE_first = MM_offset + 1
LAPTOP_APPLE_last  = MM_offset + MM_size

If (MM_rsCount <> -1) Then
  If (LAPTOP_APPLE_first > MM_rsCount) Then
    LAPTOP_APPLE_first = MM_rsCount
  End If
  If (LAPTOP_APPLE_last > MM_rsCount) Then
    LAPTOP_APPLE_last = MM_rsCount
  End If
End If
	 	...
	 	<div class="wrap">
	 		<div class="pages">
				<div class="cont1 span_2_of_g1">
				  <p>CÁC SẢN PHẨM LAPTOP APPLE MỚI NHẤT</p>
				  <p>&nbsp;</p>
                  <% 
While ((Repeat1__numRows <> 0) AND (NOT LAPTOP_APPLE.EOF)) 
%>
  <div class="oneItem">
    <p><img src="<%=(LAPTOP_APPLE.Fields.Item("HinhAnh").Value)%>" alt="" width="225" height="150">Sản phẩm: <%=(LAPTOP_APPLE.Fields.Item("TenSP").Value)%></p>
    <p>Giá: <%=(LAPTOP_APPLE.Fields.Item("Gia").Value)%></p>
    <p>Hiện còn <%=(LAPTOP_APPLE.Fields.Item("SoLuong").Value)%> sản phẩm</p>
    <p>&nbsp;</p>
    <form name="form1" method="post" action="ctspLaptop.asp">
      <input name="MaSP" type="hidden" id="MaSP" value="<%=(LAPTOP_APPLE.Fields.Item("MaSP").Value)%>">
      <label>
