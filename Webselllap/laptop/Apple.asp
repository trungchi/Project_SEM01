	 		...
	 		<div class="pages">
				<div class="cont1 span_2_of_g1">
                    ...
                    <%     dim x 'biến này dùng để xác định xem cần hiển thị trang nào     
                        ...
                        SQLstring="select * from HINHANHSP where MaSP LIKE 'LAP%'"     
                    ...
                    <% 'Hiển thị nút "Trước"     
                        if x>1 then %>     
                    <a href="Apple.asp?pageNumber=<%=x-1%>">Trước</a>     
                    <%end if%> 
                    <% 'Hiển thị nút "Tiếp"     
                        if not RS.EOF then %>        
                    <a style="padding-left: 800px;" href="Apple.asp?pageNumber=<%=x+1%>">Tiếp</a>     
                    <%end if     
