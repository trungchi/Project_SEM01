...
Dim LAPTOP_ASUS
Dim LAPTOP_ASUS_cmd
Dim LAPTOP_ASUS_numRows

Set LAPTOP_ASUS_cmd = Server.CreateObject ("ADODB.Command")
LAPTOP_ASUS_cmd.ActiveConnection = MM_Connection_STRING
LAPTOP_ASUS_cmd.CommandText = "SELECT * FROM dbo.SanPham WHERE Tinhtrang = 1 and MaLoai = 1  and MaNSX = 2" 
LAPTOP_ASUS_cmd.Prepared = true

Set LAPTOP_ASUS = LAPTOP_ASUS_cmd.Execute
LAPTOP_ASUS_numRows = 0
%>
<%
...
Repeat1__numRows = 9
Repeat1__index = 0
LAPTOP_ASUS_numRows = LAPTOP_ASUS_numRows + Repeat1__numRows
%>
<%
'  *** Recordset Stats, Move To Record, and Go To Record: declare stats variables

Dim LAPTOP_ASUS_total
Dim LAPTOP_ASUS_first
Dim LAPTOP_ASUS_last

' set the record count
LAPTOP_ASUS_total = LAPTOP_ASUS.RecordCount

' set the number of rows displayed on this page
If (LAPTOP_ASUS_numRows < 0) Then
  LAPTOP_ASUS_numRows = LAPTOP_ASUS_total
Elseif (LAPTOP_ASUS_numRows = 0) Then
  LAPTOP_ASUS_numRows = 1
End If

' set the first and last displayed record
LAPTOP_ASUS_first = 1
LAPTOP_ASUS_last  = LAPTOP_ASUS_first + LAPTOP_ASUS_numRows - 1

' if we have the correct record count, check the other stats
If (LAPTOP_ASUS_total <> -1) Then
  If (LAPTOP_ASUS_first > LAPTOP_ASUS_total) Then
    LAPTOP_ASUS_first = LAPTOP_ASUS_total
  End If
  If (LAPTOP_ASUS_last > LAPTOP_ASUS_total) Then
    LAPTOP_ASUS_last = LAPTOP_ASUS_total
  End If
  If (LAPTOP_ASUS_numRows > LAPTOP_ASUS_total) Then
    LAPTOP_ASUS_numRows = LAPTOP_ASUS_total
  End If
End If
%>
...
Set MM_rs    = LAPTOP_ASUS
MM_rsCount   = LAPTOP_ASUS_total
MM_size      = LAPTOP_ASUS_numRows
MM_uniqueCol = ""
MM_paramName = ""
MM_offset = 0
MM_atTotal = false
...
' set the first and last displayed record
LAPTOP_ASUS_first = MM_offset + 1
LAPTOP_ASUS_last  = MM_offset + MM_size

If (MM_rsCount <> -1) Then
  If (LAPTOP_ASUS_first > MM_rsCount) Then
    LAPTOP_ASUS_first = MM_rsCount
  End If
  If (LAPTOP_ASUS_last > MM_rsCount) Then
    LAPTOP_ASUS_last = MM_rsCount
  End If
End If
	 	...
	 	<div class="wrap">
	 		<div class="pages">
				<div class="cont1 span_2_of_g1">
				  <p>CÁC SẢN PHẨM LAPTOP ASUS MỚI NHẤT</p>
				  <p>&nbsp;</p>
                  <% 
While ((Repeat1__numRows <> 0) AND (NOT LAPTOP_ASUS.EOF)) 
%>
  <div class="oneItem">
    <p><img src="<%=(LAPTOP_ASUS.Fields.Item("HinhAnh").Value)%>" alt="" width="225" height="150">Sản phẩm: <%=(LAPTOP_ASUS.Fields.Item("TenSP").Value)%></p>
    <p>Giá: <%=(LAPTOP_ASUS.Fields.Item("Gia").Value)%></p>
    <p>Hiện còn <%=(LAPTOP_ASUS.Fields.Item("SoLuong").Value)%> sản phẩm</p>
    <p>&nbsp;</p>
    <form name="form1" method="post" action="ctspLaptop.asp">
      <input name="MaSP" type="hidden" id="MaSP" value="<%=(LAPTOP_ASUS.Fields.Item("MaSP").Value)%>">
      <label>
