...
<%
Dim LAPTOP_LENOVO
Dim LAPTOP_LENOVO_cmd
Dim LAPTOP_LENOVO_numRows

Set LAPTOP_LENOVO_cmd = Server.CreateObject ("ADODB.Command")
LAPTOP_LENOVO_cmd.ActiveConnection = MM_Connection_STRING
LAPTOP_LENOVO_cmd.CommandText = "SELECT * FROM dbo.SanPham WHERE Tinhtrang = 1 and MaLoai = 1  and MaNSX = 6" 
LAPTOP_LENOVO_cmd.Prepared = true

Set LAPTOP_LENOVO = LAPTOP_LENOVO_cmd.Execute
LAPTOP_LENOVO_numRows = 0
%>
<%
...
Repeat1__numRows = 9
Repeat1__index = 0
LAPTOP_LENOVO_numRows = LAPTOP_LENOVO_numRows + Repeat1__numRows
%>
<%
'  *** Recordset Stats, Move To Record, and Go To Record: declare stats variables

Dim LAPTOP_LENOVO_total
Dim LAPTOP_LENOVO_first
Dim LAPTOP_LENOVO_last

' set the record count
LAPTOP_LENOVO_total = LAPTOP_LENOVO.RecordCount

' set the number of rows displayed on this page
If (LAPTOP_LENOVO_numRows < 0) Then
  LAPTOP_LENOVO_numRows = LAPTOP_LENOVO_total
Elseif (LAPTOP_LENOVO_numRows = 0) Then
  LAPTOP_LENOVO_numRows = 1
End If

' set the first and last displayed record
LAPTOP_LENOVO_first = 1
LAPTOP_LENOVO_last  = LAPTOP_LENOVO_first + LAPTOP_LENOVO_numRows - 1

' if we have the correct record count, check the other stats
If (LAPTOP_LENOVO_total <> -1) Then
  If (LAPTOP_LENOVO_first > LAPTOP_LENOVO_total) Then
    LAPTOP_LENOVO_first = LAPTOP_LENOVO_total
  End If
  If (LAPTOP_LENOVO_last > LAPTOP_LENOVO_total) Then
    LAPTOP_LENOVO_last = LAPTOP_LENOVO_total
  End If
  If (LAPTOP_LENOVO_numRows > LAPTOP_LENOVO_total) Then
    LAPTOP_LENOVO_numRows = LAPTOP_LENOVO_total
  End If
End If
%>
...
Set MM_rs    = LAPTOP_LENOVO
MM_rsCount   = LAPTOP_LENOVO_total
MM_size      = LAPTOP_LENOVO_numRows
MM_uniqueCol = ""
MM_paramName = ""
MM_offset = 0
MM_atTotal = false
...
' set the first and last displayed record
LAPTOP_LENOVO_first = MM_offset + 1
LAPTOP_LENOVO_last  = MM_offset + MM_size

If (MM_rsCount <> -1) Then
  If (LAPTOP_LENOVO_first > MM_rsCount) Then
    LAPTOP_LENOVO_first = MM_rsCount
  End If
  If (LAPTOP_LENOVO_last > MM_rsCount) Then
    LAPTOP_LENOVO_last = MM_rsCount
  End If
End If
	 	...
	 	<div class="wrap">
	 		<div class="pages">
				<div class="cont1 span_2_of_g1">
				  <p>CÁC SẢN PHẨM LAPTOP LENOVO MỚI NHẤT</p>
				  <p>&nbsp;</p>
                  <% 
While ((Repeat1__numRows <> 0) AND (NOT LAPTOP_LENOVO.EOF)) 
%>
  <div class="oneItem">
    <p><img src="<%=(LAPTOP_LENOVO.Fields.Item("HinhAnh").Value)%>" alt="" width="225" height="150">Sản phẩm: <%=(LAPTOP_LENOVO.Fields.Item("TenSP").Value)%></p>
    <p>Giá: <%=(LAPTOP_LENOVO.Fields.Item("Gia").Value)%></p>
    <p>Hiện còn <%=(LAPTOP_LENOVO.Fields.Item("SoLuong").Value)%> sản phẩm</p>
    <p>&nbsp;</p>
    <form name="form1" method="post" action="ctspLaptop.asp">
      <input name="MaSP" type="hidden" id="MaSP" value="<%=(LAPTOP_LENOVO.Fields.Item("MaSP").Value)%>">
      <label>
