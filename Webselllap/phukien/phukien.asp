...
PHUKIEN_cmd.CommandText = "SELECT * FROM dbo.SanPham WHERE Tinhtrang = 1 and MaLoai = 4" 
...
%>
  <div class="oneItem">
    <p align="center"><img src="<%=(PHUKIEN.Fields.Item("HinhAnh").Value)%>" alt="" width="225" height="150">Sản phẩm: <%=(PHUKIEN.Fields.Item("TenSP").Value)%></p>
